            ...
            child:  Column(
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    border: OutlineInputBorder(),
                    labelText: 'Choose your date and time  here',
                  ),
                  onTap: (){
                    DatePicker.showDateTimePicker(
                      ...
                      onChanged: (date) {
                        setState(() {
                          ...
                          String formattedDate = DateFormat("yyyy-MM-ddTHH:mm:ss").format(date); // Formats only time in hours and minutes
                ...
                ElevatedButton(onPressed: () async {
                  ...
                  print(data);
                  var response=await book.addPreBooking(data);
